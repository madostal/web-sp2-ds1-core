<?php
/**
 * Toto je UNIVERZALNI LEFTMENU. Melo by se prepsat lokalni verzi, kde budou aktualni rozsireni.
 */
?>
<!-- start menu vlevo -->
<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo $base_url_link;?>"><i class="nav-icon icon-speedometer"></i> Nástěnka</a>
            </li>
            ...
            <li class="divider"></li>
            <li class="nav-title">Rozšíření</li>
